    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (userID != null)
            {
                ...
                {
                    return RedirectToAction("FeedBackForm", "Home");
                }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            Response.Cookies["mybigcookie"]["name"] = model.Email;
            Response.Cookies["mybigcookie"]["password"] = model.Password;
        ...
        public async Task<JsonResult> RegisterAllAsync(List<RegisterMutlipleUsers> model)
        {
            ...
            foreach (var eachuser in model)
            {
                using (var context = new ApplicationDbContext())
                {
                    var user = new ApplicationUser { UserName = eachuser.Email, Email = eachuser.Email };
        ...
        public  ActionResult LogOff()
        {
            ...
            if (Request.Cookies["mybigcookie"] != null)
            {
                Response.Cookies["mybigcookie"].Expires = DateTime.Now.AddDays(-1);
            }
